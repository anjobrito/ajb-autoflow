  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="rounded-3xl border border-amber-200 bg-amber-50 p-5 text-sm font-semibold text-amber-900">
        O cadastro de funcionários ainda não existe nesta branch. As comissões foram preparadas com campo de funcionário livre e employeeId opcional para futura ligação com StoredEmployee.
      </div>
