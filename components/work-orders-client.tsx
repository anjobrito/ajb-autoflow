...
export function WorkOrdersClient() {
  ...
  const responsibleColumn = profile.id === "REVENDEDORA" ? "Vendedor" : profile.id === "ESTACIONAMENTO" ? "Responsável" : "Responsável";
    ...
    <div className="grid gap-6">
      ...
      <div className="overflow-hidden rounded-3xl bg-white shadow-sm">
        <div className="border-b border-slate-100 p-6">
          ...
          <p className="mt-2 text-sm text-slate-600">Lista operacional adaptada ao perfil {profile.label}. Nesta fase os dados continuam usando o armazenamento local atual.</p>
        </div>
