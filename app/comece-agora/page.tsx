...
export default function ComeceAgoraPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    saveCompany({
      ...
      businessType: String(formData.get("businessType") ?? "Oficina mecânica"),
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-12 sm:px-10 lg:grid-cols-[1fr_520px] lg:px-16">
        ...
        <form onSubmit={handleSubmit} className="rounded-[2rem] bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-6 grid gap-4">
            ...
            <div className="grid gap-4 md:grid-cols-2"><Input name="phone" label="Telefone/WhatsApp" placeholder="Ex: (19) 99999-0000" /><Input name="email" label="E-mail" type="email" placeholder="Ex: contato@empresa.com" /></div>
          </div>
