          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="/dashboard" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-blue-500 px-6 py-4 font-bold text-white hover:bg-blue-400">
                  Abrir painel demo <ArrowRight className="h-5 w-5" />
                </a>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/10 p-4">
              <div className="rounded-[1.5rem] bg-slate-50 p-5 text-slate-950">
                ...
                <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <button className="mt-4 w-full rounded-xl bg-slate-950 px-4 py-3 text-sm font-bold text-white">Avisar cliente</button>
                </div>
              </div>
            </div>
          </div>
